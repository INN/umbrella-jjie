<?php if( is_singular( 'post' ) || is_hub('103871') ): // jjie wants the share bar on hub pages ?>
<div class="sticky-footer-holder">
	<div class="sticky-footer-container social-icons">
		...
		<?php // Comment link ?>
		<?php if ( comments_open() && is_singular( 'post' ) ): ?>
		<div class="comments">
		...
		<?php if( is_singular( 'post' ) ): // this won't be relevant on hub pages ?>
