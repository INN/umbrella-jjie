<?php
/**
 * JJIE-specific template for displaying content on the homepage.
 *
 * This duplicates Largo's partials/content.php for the homepage river area.
 * The only difference is the name of the slug searched for for $featured.
 *
 * @see jjie_add_homepage_large_image_prominence
 * @since Largo 0.5
 */
$tags = of_get_option( 'tag_display' );
$hero_class = largo_hero_class( $post->ID, FALSE );
$values = get_post_custom( $post->ID );
$featured = has_term( 'homepage-large-image', 'prominence' )
?>
